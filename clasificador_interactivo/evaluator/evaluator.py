...
from .decoder import decode_tag
...
# Cargo los vectores
vecs = np.load("{}/evaluator/embeddings/emb39-word2vec.npy".format(location))

# Obtenemos la lista de palabras
with open("{}/evaluator/embeddings/emb39-word2vec.txt".format(location)) as f:
